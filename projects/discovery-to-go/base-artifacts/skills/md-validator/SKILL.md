...
description: "Valida arquivos .md contra as convencoes do workspace usando o validador Python. Use SEMPRE que precisar: verificar se um .md esta em conformidade (frontmatter, headings, emojis, siglas, naming, section-order), auditar uma pasta inteira de .md recursivamente, ou corrigir problemas automaticamente (modo --fix). Aceita arquivo unico ou pasta. 10 regras: frontmatter, heading, emoji, section-order, acronym, wikilink, callout, diagram, naming, skill-fields. NAO use para: formatar/reescrever o .md (use md-writer), gerar HTML (use html-writer), ou criar skills (use skill-writer)."
project-name: global
version: 01.00.000
author: claude-code
license: MIT
