...
O catálogo de custom-specialists para projetos web-microservices está no **spec-pack** correspondente: [[../web-microservices/specialists|knowledge/web-microservices/specialists.md]]. O orchestrator carrega o spec-pack junto com este context-pack durante o Setup.
