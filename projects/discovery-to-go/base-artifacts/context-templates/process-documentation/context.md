...
O catálogo de custom-specialists para projetos de documentação de processos está no **spec-pack** correspondente: [[../process-documentation/specialists|context-templates/process-documentation/specialists.md]]. O orchestrator carrega o spec-pack junto com este context-pack durante o Setup.
