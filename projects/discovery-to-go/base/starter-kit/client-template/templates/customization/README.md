...
| `iteration-policy.md` | Limites de iteração, prazo planejamento/MVP, threshold de estagnação | `starter-kit/client-template/templates/customization/` |
...
| `one-pager-layout.md` | Regions obrigatórias do entregável OP (distiller usa como piso) | `starter-kit/client-template/templates/customization/` |
| `executive-layout.md` | Regions obrigatórias do entregável EX (distiller usa como piso) | `starter-kit/client-template/templates/customization/` |
