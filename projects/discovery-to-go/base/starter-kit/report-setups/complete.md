---
title: "Report Setup — Completo (legacy — catálogo de regions do full-report.html)"
description: "Catálogo das regions que o html-writer monta para o full-report.html (todas as ~85-91 regions). Legacy: não use como setting do briefing — declare `deliverables_scope: [\"DR\", \"OP\", \"EX\"]` em vez disso."
project-name: discovery-to-go
version: 01.01.000
status: legacy
deprecated-as-briefing-flag: true
superseded-by: ["deliverables_scope", "html-layout.md"]
...
> [!warning] Legacy
> Este arquivo permanece como **catálogo de referência** das regions do `full-report.html`. Mas **não deve mais ser citado no briefing** como `report-setup: complete`. Use `deliverables_scope: ["DR", "OP", "EX"]` — o DR já é superconjunto (ADR-001) e inclui tudo o que este setup listava. Ver [report-setups/README.md](README.md#migração-do-briefing).
