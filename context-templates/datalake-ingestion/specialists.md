...
> Este spec-pack é carregado em conjunto com o `context-templates/datalake-ingestion/context.md` durante o **Setup** do pipeline. Enquanto o context define **concerns** e **perguntas recomendadas**, este specialists define **quais custom-specialists estão disponíveis** para serem invocados dinamicamente pelo orchestrator.
