...
O catálogo de custom-specialists para projetos de ingestão de datalake está no **spec-pack** correspondente: [[../datalake-ingestion/specialists|context-templates/datalake-ingestion/specialists.md]]. O orchestrator carrega o spec-pack junto com este context-pack durante o Setup.
