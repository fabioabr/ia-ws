...
O catálogo de custom-specialists para projetos SaaS está no **spec-pack** correspondente: [[../saas/specialists|context-templates/saas/specialists.md]]. O orchestrator carrega o spec-pack junto com este context-pack durante o Setup. Quando po, solution-architect ou cyber-security-architect pedirem `help` em subtópico específico durante a reunião, o orchestrator consulta aquele catálogo.
